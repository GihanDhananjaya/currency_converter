...
class _AppTextFieldState extends State<AppTextField> {
  ...
  Color prefixIconColor = AppColors.fontColorGray; // Initial color
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        disabledBorder: UnderlineInputBorder(
          borderSide: BorderSide(color: AppColors.fontColorGray, width: 2),
          borderRadius: BorderRadius.all(
            Radius.circular(borderRadius),
          ),
        ),
        ...
        counterText: "",
        prefixIcon: Padding(
          padding: EdgeInsets.only(right: 18), // Adjust the space here
